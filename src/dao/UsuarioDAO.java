...
public class UsuarioDAO implements dao.Persistencia<Usuario> {
    ...
    public int create(Usuario c) {
        ...
        ResultSet rs = null;
        String sql = "INSERT INTO Usuario(nome,usuario,senha,nivel,foto) VALUES"
                + "(?,?,?,?,?)";
        try{
    ...
    public Usuario findByCodigo(int id) {
        ...
        try{
            ...
            while (rs.next()){
                ...
                c = new Usuario(codigo,nome,usuario,senha,nivel,foto);
            }
    ...
    public Usuario findByUsuario(String user) {
        ...
        try{
            ...
            while (rs.next()){
                ...
                c = new Usuario(nome,usuario,senha,nivel,foto);
            }
    ...
    public void update(Usuario c) {
        ...
        PreparedStatement pst = null;
        ResultSet rs = null;
        String sql = "UPDATE usuario set nome=?,senha=?,nivel=?, foto=? where usuario=?";
        try{
            pst = con.prepareStatement(sql);
            pst.setString(1, c.getNome());
